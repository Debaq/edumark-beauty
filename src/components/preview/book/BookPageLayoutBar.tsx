...
export function BookPageLayoutBar({ currentLayout, onSelectLayout }: Props) {
  return (
    <div className="edm-book-page-layout-bar">
      {LAYOUTS.map(({ id, label, icon }) => (
        <button
          ...
          title={label}
          className={clsx(
            'edm-book-page-layout-btn',
            currentLayout === id && 'active'
          )}
        >
          {icon}
        </button>
